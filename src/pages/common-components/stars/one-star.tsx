...
export type TStarsProps = React.ImgHTMLAttributes<HTMLImageElement> & {
    width?: string
    height?: string
    isStarColor1?: boolean
    isStarColor2?: boolean
    isStarColor3?: boolean
    isStarColor4?: boolean
    isStarColor5?: boolean
}

export const Star: React.FC<TStarsProps> = ({width = '24px', height = '24px', isStarColor1, isStarColor2, isStarColor3, isStarColor4, isStarColor5}) => (

    <svg
        width={width}
        height={height}
         viewBox="0 0 25 24"
         fill={(isStarColor1 || isStarColor2 || isStarColor3 || isStarColor4 || isStarColor5) ? '#FFBC1F' : 'none' }
